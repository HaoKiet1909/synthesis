...
{
    public partial class Form_Hoatdong68_Tyledonthuoc : Form
    {
        public Form_Hoatdong68_Tyledonthuoc()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_Hoatdong68_Tyledonthuoc_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // URL của Node.js API
                    string url = $"http://synthesisreport.tmhsg.com/get_tyledonthuoc_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}";
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("HoatDong68_TyLeBanThuoc_2023", con);
            ...
            reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_Hoatdong68_Tylebanthuoc.rdlc";
           // reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_Hoatdong68_Tylebanthuoc";
            ...
            ReportDataSource rdsMerged = new ReportDataSource("DataSetTyledonthuoc", dtMerged);
