...
{
    public partial class Form_KHTH_danhsachbnpt : Form
    {
        public Form_KHTH_danhsachbnpt()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_KHTH_danhsachbnpt_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            if (cbbchinhanh.SelectedItem == "BV")
            {
                ...
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_khth_danhsachbnpt_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("get_khth_danhsachbnpt_2024", con);
                ...
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_danhsachbnpt.rdlc";
                //reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_KHTH_danhsachbnpt.rdlc";
