...
{
    public partial class Form_KHTH_tinhhinhsudungthuoctheobacsi : Form
    {
        public Form_KHTH_tinhhinhsudungthuoctheobacsi()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_KHTH_tinhhinhsudungthuoctheobacsi_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            if (cbbchinhanh.SelectedItem == "9-15")
            {
                ...
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_khth_tinhhinhsudungthuoctheobacsi_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
                            ...
                            List<string> columnsToConvert = new List<string>
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("get_khth_tinhhinhsudungthuoctheobacsi_2024", con);
                            ...
                            List<string> columnsToConvert = new List<string>
            {
                ...
                // Hiển thị báo cáo RDLC với dữ liệu từ DataTable hợp nhất
                reporttinhhinhkcbtmh.ProcessingMode = ProcessingMode.Local;
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_tinhhinhsudungthuoctheobacsi.rdlc";
               // reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_KHTH_tinhhinhsudungthuoctheobacsi.rdlc";
                reporttinhhinhkcbtmh.LocalReport.DataSources.Clear();
