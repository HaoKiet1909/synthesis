...
{
    public partial class Form_KHTH_thongkesoravaochuyenvien : Form
    {
        public Form_KHTH_thongkesoravaochuyenvien()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_KHTH_thongkesoravaochuyenvien_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            if (cbbchinhanh.SelectedItem == "9-15")
            {
                ...
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_khth_thongkenhapxuatvienchuyenkhoa_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
...
"ngaydieutri",
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("get_khth_thongkenhapxuatvienchuyenkhoa_2024", con);
...
"ngaydieutri",
                ...
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_thongkesoravaochuyenvien.rdlc";
...
"ngaydieutri",
                ...
                reporttinhhinhkcbtmh.ProcessingMode = ProcessingMode.Local;
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_thongkesoravaochuyenvien.rdlc";
                //reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_KHTH_thongkesoravaochuyenvien.rdlc";
                reporttinhhinhkcbtmh.LocalReport.DataSources.Clear();
