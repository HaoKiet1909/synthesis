...
{
    public partial class Form_KHTH_tinhhinhhoatdongcls : Form
    {
        public Form_KHTH_tinhhinhhoatdongcls()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_KHTH_hoatdongcanlamsang_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            if (cbbchinhanh.SelectedItem == "BV")
            {
                ...
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_khth_tinhhinhhoatdongcls_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
...
"ngoaitru",
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("get_khth_hoatdongcls_2024", con);
...
"ngoaitru",
                ...
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_tinhhinhhoatdongcls.rdlc";
                //reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_KHTH_tinhhinhhoatdongcls.rdlc";
