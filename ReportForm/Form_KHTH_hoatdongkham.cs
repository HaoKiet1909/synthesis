...
{
    public partial class Form_KHTH_hoatdongkham : Form
    {
        SqlConnection con;

        public Form_KHTH_hoatdongkham()
        {
            InitializeComponent();
        }

        private void Form_KHTH_hoatdongkham_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            if (cbbchinhanh.SelectedItem == "9-15")
            {
                ...
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_khth_hoatdongphongkham_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
                            ...
                            List<string> columnsToConvert = new List<string>
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("get_khth_hoatdongphongkham_2024", con);
