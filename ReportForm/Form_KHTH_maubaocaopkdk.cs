...
{
    public partial class Form_KHTH_maubaocaopkdk : Form
    {
        public Form_KHTH_maubaocaopkdk()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_KHTH_maubaocaopkdk_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            DataTable dtMerged = new DataTable();
                ...
                if (cbbchinhanh.SelectedItem == "9-15")
                {
                    ...
                    try
                    {
                        ...
                        {
                            // URL của Node.js API
                            string url = $"http://synthesisreport.tmhsg.com/get_khth_maubaocaopk_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
                                ...
                                List<string> columnsToConvert = new List<string>
            {
                "tong"
                    ...
                    try
                    {
                        SqlCommand cmd = new SqlCommand("get_khth_maubaocaopk_2024", con);
                    ...
                    reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_maubaocaopkdk.rdlc";
                                ...
                                List<string> columnsToConvert = new List<string>
            {
                ...
                else
                {
                    ...
                    //reporttinhhinhkcbtmh.ProcessingMode = ProcessingMode.Local;
                    //reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpTongdoanhthumotkhach3Chinhanh.rdlc";
                    ...
                    //    reporttinhhinhkcbtmh.LocalReport.DataSources.Clear();
                    //    reporttinhhinhkcbtmh.LocalReport.DataSources.Add(rds);
                    //    ReportParameterCollection reportParameters = new ReportParameterCollection();
