...
{
    public partial class Form_Hoatdong68_Tinhhinhkcbtmh : Form
    {
        public Form_Hoatdong68_Tinhhinhkcbtmh()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_Hoatdong68_Tinhhinhkcbtmh_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            //try
            //{
            //    SqlCommand cmd = new SqlCommand("Hoatdong68_TinhHinhKCBTMH_2023", con);
            ...
            //    reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_Hoatdong68_Tinhhinhkcbtmh.rdlc";
            //    if (ds.Tables[0].Rows.Count > 0)
            //    {
            //        ReportDataSource rds = new ReportDataSource();
            //        rds.Name = "DataSetTinhhinhkcbtmh";
            ...
            try
            {
                ...
                {
                    // URL của Node.js API
                    string url = $"http://synthesisreport.tmhsg.com/get_hoatdong68_tinhhinhhoatdong_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}";
            ...
            ReportDataSource rdsMerged = new ReportDataSource("DataSetTinhhinhkcbtmh", dtMerged);
