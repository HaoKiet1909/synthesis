...
{
    public partial class Form_DT_Thammy : Form
    {
        public Form_DT_Thammy()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Rpthammy_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            //    SqlCommand cmd = new SqlCommand("DoanhThuThamMy_2023", con);
            ...
            //    reportthammy.ProcessingMode = ProcessingMode.Local;
            //    reportthammy.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpDoanhThuThamMy.rdlc";
            //    if (ds.Tables[0].Rows.Count > 0)
            //    {
            //        ReportDataSource rds = new ReportDataSource();
            //        rds.Name = "DataSet1";
            //        rds.Value = ds.Tables[0];
            //        reportthammy.LocalReport.DataSources.Clear();
            //        reportthammy.LocalReport.DataSources.Add(rds);
            ...
            //        reportthammy.LocalReport.SetParameters(reportParameters);
            //        reportthammy.RefreshReport();
            //    }
            ...
            try
            {
                ...
                {
                    // URL của Node.js API
                    string url = $"http://synthesisreport.tmhsg.com/get_doanhthu_thammy_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}";
            ...
            ReportDataSource rdsMerged = new ReportDataSource("DataSet1", dtMerged);
            reportthammy.LocalReport.DataSources.Add(rdsMerged);
