...
{
    public partial class Form_KHTH_danhsachbnnn : Form
    {
        public Form_KHTH_danhsachbnnn()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_KHTH_danhsachbnnn_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            if (cbbchinhanh.SelectedItem == "BV")
            {
                ...
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_khth_dsbenhnhannuocngoai_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("get_khth_dsbenhnhannuocngoai_2024", con);
                ...
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_danhsachbnnn.rdlc";
                //reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_KHTH_danhsachbnnn.rdlc";
