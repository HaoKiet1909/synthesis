...
{
    public partial class Form_KHTH_hoatdongkhambenh : Form
    {
        public Form_KHTH_hoatdongkhambenh()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_KHTH_hoatdongkhambenh_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            if (cbbchinhanh.SelectedItem == "9-15")
            {
                ...
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_khth_hoatdongkhambenh_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
...
"songay",
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("get_khth_hoatdongkhambenh_2024", con);
...
"songay",
                ...
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_hoatdongkhambenh.rdlc";
...
"songay",
                ...
                reporttinhhinhkcbtmh.ProcessingMode = ProcessingMode.Local;
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_hoatdongkhambenh.rdlc";
                //reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_KHTH_hoatdongkhambenh.rdlc";
                reporttinhhinhkcbtmh.LocalReport.DataSources.Clear();
