...
{
    public partial class Form_KHTH_thongkebenhtattheobenhnhankhambenh : Form
    {
        public Form_KHTH_thongkebenhtattheobenhnhankhambenh()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_KHTH_thongkebenhtattheobenhnhankhambenh_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            if (cbbchinhanh.SelectedItem == "9-15")
            {
                ...
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_khth_thongkebenhtattheobnkb_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
...
"khac",
                            ...
                            foreach (string columnName in columnsToConvert)
                            {
                                ...
                                {
                                    dtPostgreSQLCorrected.Columns[columnName].DataType = typeof(Int64);
                                }
                            }
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("get_khth_thongkebenhtattheobnkb_2024", con);
...
"khac",
                    ...
                    foreach (string columnName in columnsToConvert)
                    {
                        ...
                        {
                            dtSQLServerCorrected.Columns[columnName].DataType = typeof(Int64);
                        }
                    }
                ...
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\get_khth_thongkebenhtattheobnkb_2024.rdlc";
                //reporttinhhinhkcbtmh.LocalReport.ReportPath = "RpTongdoanhthumotkhach.rdlc";
...
"khac",
                ...
                // Hiển thị báo cáo RDLC với dữ liệu từ DataTable hợp nhất
                reporttinhhinhkcbtmh.ProcessingMode = ProcessingMode.Local;
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_thongketinhhinhhoatdongkhambenh.rdlc";
                //reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_KHTH_thongketinhhinhhoatdongkhambenh.rdlc";
                reporttinhhinhkcbtmh.LocalReport.DataSources.Clear();
...
"khac",
                ...
                // Hiển thị báo cáo RDLC với dữ liệu từ DataTable hợp nhất
                reporttinhhinhkcbtmh.ProcessingMode = ProcessingMode.Local;
                //reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_thongkebenhtattheobnkb.rdlc";
                 reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_KHTH_thongkebenhtattheobnkb.rdlc";
                reporttinhhinhkcbtmh.LocalReport.DataSources.Clear();
