...
{
    public partial class Form_MKT_Tongdoanhthumotkhach : Form
    {
        public Form_MKT_Tongdoanhthumotkhach()
        {
            InitializeComponent();
        }
        SqlConnection con;
        SqlConnection con1;
        SqlConnection con2;
        private void FormTongdoanhthumotkhach_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    //SqlCommand cmd = new SqlCommand("DoanhThuMotKhachHang_2023", con);
                    ...
                    //reporttongdoanhthumotkhach.ProcessingMode = ProcessingMode.Local;
                    //reporttongdoanhthumotkhach.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpTongdoanhthumotkhach.rdlc";
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    //    ReportDataSource rds = new ReportDataSource();
                    //    rds.Name = "DataSetTongdoanhthumotkhach";
                    //    rds.Value = ds.Tables[0];
                    //    reporttongdoanhthumotkhach.LocalReport.DataSources.Clear();
                    //    reporttongdoanhthumotkhach.LocalReport.DataSources.Add(rds);
                    ...
                    //    reporttongdoanhthumotkhach.LocalReport.SetParameters(reportParameters);
                    //    reporttongdoanhthumotkhach.RefreshReport();
                    try
                    {
                        dtMerged.Clear();
                        ...
                        {
                            // URL của Node.js API
                            string url = $"http://synthesisreport.tmhsg.com/get_marketing_doanhthumotkhach_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
                                ...
                                List<string> columnsToConvert = new List<string>
            {
                "tong"
                    ...
                    reporttongdoanhthumotkhach.ProcessingMode = ProcessingMode.Local;
                    reporttongdoanhthumotkhach.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpTongdoanhthumotkhach.rdlc";
                    //reporttongdoanhthumotkhach.LocalReport.ReportPath = "RpTongdoanhthumotkhach.rdlc";
                    reporttongdoanhthumotkhach.LocalReport.DataSources.Clear();

                    // Thêm dữ liệu từ DataTable hợp nhất (PostgreSQL và SQL Server)
                    ReportDataSource rdsMerged = new ReportDataSource("DataSetTongdoanhthumotkhach", dtMerged);
                    reporttongdoanhthumotkhach.LocalReport.DataSources.Add(rdsMerged);
                ...
                {
                    //SqlCommand cmd = new SqlCommand("DoanhThuMotKhachHang_2023", con2);
                    //cmd.CommandType = CommandType.StoredProcedure;
                    //cmd.Parameters.AddWithValue("@TuNgay", TuNgay.Value.ToString("yyyy/MM/dd"));
                    //cmd.Parameters.AddWithValue("@DenNgay", DenNgay.Value.ToString("yyyy/MM/dd"));
                    ...
                    //reporttongdoanhthumotkhach.ProcessingMode = ProcessingMode.Local;
                    //reporttongdoanhthumotkhach.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpTongdoanhthumotkhachBv.rdlc";
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    //    ReportDataSource rds = new ReportDataSource();
                    //    rds.Name = "DataSetDoanhthumotkhachhangBv";
                    //    rds.Value = ds.Tables[0];
                    //    reporttongdoanhthumotkhach.LocalReport.DataSources.Clear();
                    //    reporttongdoanhthumotkhach.LocalReport.DataSources.Add(rds);
                    //    ReportParameterCollection reportParameters = new ReportParameterCollection();
                                ...
                                List<string> columnsToConvert = new List<string>
            {
                "tong"
                    ...
                    reporttongdoanhthumotkhach.ProcessingMode = ProcessingMode.Local;
                    reporttongdoanhthumotkhach.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpTongdoanhthumotkhachBv.rdlc";
                    //reporttongdoanhthumotkhach.LocalReport.ReportPath = "RpTongdoanhthumotkhachBv.rdlc";
                    reporttongdoanhthumotkhach.LocalReport.DataSources.Clear();

                    // Thêm dữ liệu từ DataTable hợp nhất (PostgreSQL và SQL Server)
                    ReportDataSource rdsMerged = new ReportDataSource("DataSetDoanhthumotkhachhangBv", dtMerged);
                    reporttongdoanhthumotkhach.LocalReport.DataSources.Add(rdsMerged);
                ...
                {
                    //SqlCommand cmd = new SqlCommand("DoanhThuMotKhachHang_2023", con1);
                    //cmd.CommandType = CommandType.StoredProcedure;
                    //cmd.Parameters.AddWithValue("@TuNgay", TuNgay.Value.ToString("yyyy/MM/dd"));
                    //cmd.Parameters.AddWithValue("@DenNgay", DenNgay.Value.ToString("yyyy/MM/dd"));
                    ...
                    //reporttongdoanhthumotkhach.ProcessingMode = ProcessingMode.Local;
                    //reporttongdoanhthumotkhach.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpTongdoanhthumotkhachQ7.rdlc";
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    //    ReportDataSource rds = new ReportDataSource();
                    //    rds.Name = "DataSetDoanhthumotkhachhangQ7";
                    //    rds.Value = ds.Tables[0];
                    //    reporttongdoanhthumotkhach.LocalReport.DataSources.Clear();
                    //    reporttongdoanhthumotkhach.LocalReport.DataSources.Add(rds);
                    //    ReportParameterCollection reportParameters = new ReportParameterCollection();
                                ...
                                List<string> columnsToConvert = new List<string>
            {
                "tong"
                    ...
                    reporttongdoanhthumotkhach.ProcessingMode = ProcessingMode.Local;
                    reporttongdoanhthumotkhach.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpTongdoanhthumotkhachQ7.rdlc";
                    //reporttongdoanhthumotkhach.LocalReport.ReportPath = "RpTongdoanhthumotkhachQ7.rdlc";
                    reporttongdoanhthumotkhach.LocalReport.DataSources.Clear();

                    // Thêm dữ liệu từ DataTable hợp nhất (PostgreSQL và SQL Server)
                    ReportDataSource rdsMerged = new ReportDataSource("DataSetDoanhthumotkhachhangQ7", dtMerged);
                    reporttongdoanhthumotkhach.LocalReport.DataSources.Add(rdsMerged);
                ...
                {
                    //SqlCommand cmd = new SqlCommand("DoanhThuMotKhachHang3Chinhanh_2023", con);
                    //cmd.CommandType = CommandType.StoredProcedure;
                    //cmd.Parameters.AddWithValue("@TuNgay", TuNgay.Value.ToString("yyyy/MM/dd"));
                    //cmd.Parameters.AddWithValue("@DenNgay", DenNgay.Value.ToString("yyyy/MM/dd"));
                    ...
                    //reporttongdoanhthumotkhach.ProcessingMode = ProcessingMode.Local;
                    //reporttongdoanhthumotkhach.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpTongdoanhthumotkhach3Chinhanh.rdlc";
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    //    ReportDataSource rds = new ReportDataSource();
                    //    rds.Name = "DataSetDoanhthumotkhachhang3Chinhanh";
                    //    rds.Value = ds.Tables[0];
                    //    reporttongdoanhthumotkhach.LocalReport.DataSources.Clear();
                    //    reporttongdoanhthumotkhach.LocalReport.DataSources.Add(rds);
                    //    ReportParameterCollection reportParameters = new ReportParameterCollection();
                    ...
                    try
                    {
                        ...
                        {
                            // URL của Node.js API
                            string url = $"http://synthesisreport.tmhsg.com/get_marketing_doanhthumotkhach_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}";
                                ...
                                List<string> columnsToConvert = new List<string>
            {
                "tong"
                    ...
                    reporttongdoanhthumotkhach.ProcessingMode = ProcessingMode.Local;
                    reporttongdoanhthumotkhach.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpTongdoanhthumotkhach3Chinhanh.rdlc";
                    //reporttongdoanhthumotkhach.LocalReport.ReportPath = "RpTongdoanhthumotkhach3Chinhanh.rdlc";
                    reporttongdoanhthumotkhach.LocalReport.DataSources.Clear();

                    // Thêm dữ liệu từ DataTable hợp nhất (PostgreSQL và SQL Server)
                    ReportDataSource rdsMerged = new ReportDataSource("DataSetDoanhthumotkhachhang3Chinhanh", dtMerged);
                    reporttongdoanhthumotkhach.LocalReport.DataSources.Add(rdsMerged);
