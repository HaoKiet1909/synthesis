...
{
    public partial class Form_DT_Goikhamconlai : Form
    {
        public Form_DT_Goikhamconlai()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_DT_Goikhamconlai_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //SqlCommand cmd = new SqlCommand("DT_DoanhThuGoiKhamConLai_2023", con);
                ...
                //dap.Fill(ds);
                //reportDoanhthugoikhamconlai.ProcessingMode = ProcessingMode.Local;
                //reportDoanhthugoikhamconlai.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_DT_Goikhamconlai.rdlc";
                //if (ds.Tables[0].Rows.Count > 0)
                //{
                //    ReportDataSource rds = new ReportDataSource();
                //    rds.Name = "DataSetGoikhamconlai";
                //    rds.Value = ds.Tables[0];
                //    reportDoanhthugoikhamconlai.LocalReport.DataSources.Clear();
                //    reportDoanhthugoikhamconlai.LocalReport.DataSources.Add(rds);
                ...
                //    reportDoanhthugoikhamconlai.LocalReport.SetParameters(reportParameters);
                //    reportDoanhthugoikhamconlai.RefreshReport();
                //}
                //con.Close();
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_doanhthu_nhunggoikhac_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}";
                ...
                ReportDataSource rdsMerged = new ReportDataSource("DataSetGoikhamconlai", dtMerged);
                reportDoanhthugoikhamconlai.LocalReport.DataSources.Add(rdsMerged);
