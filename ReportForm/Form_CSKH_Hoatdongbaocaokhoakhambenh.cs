...
{
    public partial class Form_CSKH_Hoatdongbaocaokhoakhambenh : Form
    {
        public Form_CSKH_Hoatdongbaocaokhoakhambenh()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void FormHoatdongbaocaokhoakhambenh_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            //    SqlCommand cmd = new SqlCommand("HoatDongKhoaKhamBenh_2023", con);
            ...
            //    dap.Fill(ds);
            //    reportHoatdongbaocaokhambenh.ProcessingMode = ProcessingMode.Local;
            //    reportHoatdongbaocaokhambenh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_CSKH_Hoatdongbaocaokhambenh.rdlc";
            //    if (ds.Tables[0].Rows.Count > 0)
            //    {
            //        ReportDataSource rds = new ReportDataSource();
            //        rds.Name = "DataSetHoatdongkhoakhambenh";
            //        rds.Value = ds.Tables[0];
            //        reportHoatdongbaocaokhambenh.LocalReport.DataSources.Clear();
            //        reportHoatdongbaocaokhambenh.LocalReport.DataSources.Add(rds);
            ...
            //        reportHoatdongbaocaokhambenh.LocalReport.SetParameters(reportParameters);
            //        reportHoatdongbaocaokhambenh.RefreshReport();
            //    }
            //    con.Close();
            //}
            //catch (Exception ex)
            ...
            try
            {
                ...
                {
                    // URL của Node.js API
                    string url = $"http://synthesisreport.tmhsg.com/get_cskh_hoatdongkhoakhambenh_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}";
            ...
            reportHoatdongbaocaokhambenh.ProcessingMode = ProcessingMode.Local;
            reportHoatdongbaocaokhambenh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_CSKH_Hoatdongbaocaokhambenh.rdlc";
            //reportDoanhthugoikhamconlai.LocalReport.ReportPath = "Rp_DT_Goikhamconlai.rdlc";
            reportHoatdongbaocaokhambenh.LocalReport.DataSources.Clear();

            // Thêm dữ liệu từ DataTable hợp nhất (PostgreSQL và SQL Server)
            ReportDataSource rdsMerged = new ReportDataSource("DataSetHoatdongkhoakhambenh", dtMerged);
            reportHoatdongbaocaokhambenh.LocalReport.DataSources.Add(rdsMerged);
