...
{
    public partial class Form_MKT_Khachtmh : Form
    {
        public Form_MKT_Khachtmh()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_MKT_Khachtmh_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_MKT_Khachtmh.rdlc";
                //if (ds.Tables[0].Rows.Count > 0)
                //{
                //    ReportDataSource rds = new ReportDataSource();
                //    rds.Name = "DataSetKhachtmh";
                            ...
                            List<string> columnsToConvert = new List<string>
            {
                ...
                reportsoluotkham.ProcessingMode = ProcessingMode.Local;
                reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_MKT_Khachtmh.rdlc";
                //reportsoluotkham.LocalReport.ReportPath = "Rp_MKT_Khachtmh.rdlc";
                reportsoluotkham.LocalReport.DataSources.Clear();

                // Thêm dữ liệu từ DataTable hợp nhất (PostgreSQL và SQL Server)
                ReportDataSource rdsMerged = new ReportDataSource("DataSetKhachtmh", dtMerged);
