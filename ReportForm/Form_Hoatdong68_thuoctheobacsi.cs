...
{
    public partial class Form_Hoatdong68_banthuoctheobacsi : Form
    {
        public Form_Hoatdong68_banthuoctheobacsi()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_Hoatdong68_banthuoctheobacsi_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // URL của Node.js API
                    string url = $"http://synthesisreport.tmhsg.com/get_hoatdong68_banthuoctheobacsi_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}";
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("HoatDong68_banthuoctheobacsi_2023", con);
            ...
            reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_Hoatdong68_banthuoctheobacsi.rdlc";
            ...
            ReportDataSource rdsMerged = new ReportDataSource("DataSetDonthuoctheobacsi", dtMerged);
