...
{
    public partial class Form_KHTH_hoatdongdieutri : Form
    {
        public Form_KHTH_hoatdongdieutri()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_KHTH_hoatdongdieutri_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            if (cbbchinhanh.SelectedItem == "BV")
            {
                ...
                try
                {
                    ...
                    {
                        // URL của Node.js API
                        string url = $"http://synthesisreport.tmhsg.com/get_khth_hoatdongdieutri_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
...
"cuoi_ky",
                ...
                reporttinhhinhkcbtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_KHTH_hoatdongdieutri.rdlc";
                //reporttinhhinhkcbtmh.LocalReport.ReportPath = "Rp_KHTH_hoatdongdieutri.rdlc";
