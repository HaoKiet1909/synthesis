...
{
    public partial class Form_Hoatdong68_KhachKhamhTMH : Form
    {
        public Form_Hoatdong68_KhachKhamhTMH()
        {
            InitializeComponent();
        }
        SqlConnection con;
        private void Form_Hoatdong68_KhachKhamhTMH_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            //try
            //{
            //    SqlCommand cmd = new SqlCommand("MKT_KhachTMH_2023", con);
            ...
            //    reportkhachkhamtmh.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\Rp_Hoatdong68_Khachkhamtmh.rdlc";
            //    if (ds.Tables[0].Rows.Count > 0)
            //    {
            //        ReportDataSource rds = new ReportDataSource();
            //        rds.Name = "DataSetKhachkhamtmh";
            ...
            try
            {
                ...
                {
                    // URL của Node.js API
                    string url = $"http://synthesisreport.tmhsg.com/get_marketing_khachkhamtmh_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}";
                        ...
                        List<string> columnsToConvert = new List<string>
{
            ...
            ReportDataSource rdsMerged = new ReportDataSource("DataSetKhachkhamtmh", dtMerged);
            reportkhachkhamtmh.LocalReport.DataSources.Add(rdsMerged);
