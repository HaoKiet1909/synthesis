...
{
    public partial class Form_MKT_Soluotkham : Form
    {
        public Form_MKT_Soluotkham()
        {
            InitializeComponent();
        }
        SqlConnection con;
        SqlConnection con1;
        SqlConnection con2;
        private void FormSoluotkham_Load(object sender, EventArgs e)
        {
        ...
        private async void btntimkiemngay_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (cbbchinhanh.SelectedItem == "9-15")
                {
                    ...
                    //SqlCommand cmd = new SqlCommand("SoLuotKham_2023", con);
                    ...
                    //reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpSoluotkham.rdlc";
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    //    ReportDataSource rds = new ReportDataSource();
                    //    rds.Name = "DataSetSoluotkham";
                    ...
                    try
                    {
                        ...
                        {
                            // URL của Node.js API
                            string url = $"http://synthesisreport.tmhsg.com/get_marketing_solankhammotkhach_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}&facility={facility}";
                                ...
                                List<string> columnsToConvert = new List<string>
            {
                "solandenkham"
                    ...
                    reportsoluotkham.ProcessingMode = ProcessingMode.Local;
                    reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpSoluotkham.rdlc";
                    //reportsoluotkham.LocalReport.ReportPath = "RpSoluotkham.rdlc";
                    reportsoluotkham.LocalReport.DataSources.Clear();
                ...
                {
                    //SqlCommand cmd = new SqlCommand("SoLuotKham_2023", con1);
                    //cmd.CommandType = CommandType.StoredProcedure;
                    //cmd.Parameters.AddWithValue("@TuNgay", TuNgay.Value.ToString("yyyy/MM/dd"));
                    //cmd.Parameters.AddWithValue("@DenNgay", DenNgay.Value.ToString("yyyy/MM/dd"));
                    ...
                    //reportsoluotkham.ProcessingMode = ProcessingMode.Local;
                    //reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpSoluotkhamQ7.rdlc";
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    //    ReportDataSource rds = new ReportDataSource();
                    //    rds.Name = "DataSetSoluotkhamQ7";
                    //    rds.Value = ds.Tables[0];
                    //    reportsoluotkham.LocalReport.DataSources.Clear();
                    //    reportsoluotkham.LocalReport.DataSources.Add(rds);
                    //    ReportParameterCollection reportParameters = new ReportParameterCollection();
                                ...
                                List<string> columnsToConvert = new List<string>
            {
                "solandenkham"
                    ...
                    reportsoluotkham.ProcessingMode = ProcessingMode.Local;
                    reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpSoluotkhamQ7.rdlc";
                    //reportsoluotkham.LocalReport.ReportPath = "RpSoluotkhamQ7.rdlc";
                    reportsoluotkham.LocalReport.DataSources.Clear();

                    // Thêm dữ liệu từ DataTable hợp nhất (PostgreSQL và SQL Server)
                    ReportDataSource rdsMerged = new ReportDataSource("DataSetSoluotkhamQ7", dtMerged);
                    reportsoluotkham.LocalReport.DataSources.Add(rdsMerged);
                ...
                {
                    //SqlCommand cmd = new SqlCommand("SoLuotKham_2023", con2);
                    //cmd.CommandType = CommandType.StoredProcedure;
                    //cmd.Parameters.AddWithValue("@TuNgay", TuNgay.Value.ToString("yyyy/MM/dd"));
                    //cmd.Parameters.AddWithValue("@DenNgay", DenNgay.Value.ToString("yyyy/MM/dd"));
                    ...
                    //reportsoluotkham.ProcessingMode = ProcessingMode.Local;
                    //reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpSoluotkhamBv.rdlc";
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    //    ReportDataSource rds = new ReportDataSource();
                    //    rds.Name = "DataSetSoluotkhamBv";
                    //    rds.Value = ds.Tables[0];
                    //    reportsoluotkham.LocalReport.DataSources.Clear();
                    //    reportsoluotkham.LocalReport.DataSources.Add(rds);
                    //    ReportParameterCollection reportParameters = new ReportParameterCollection();
    ...
    "solandenkham"
                        ...
                        List<string> columnsToConvert = new List<string>
        {
            "solandenkham"
                    ...
                    reportsoluotkham.ProcessingMode = ProcessingMode.Local;
                    reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpSoluotkhamBv.rdlc";
                    //reportsoluotkham.LocalReport.ReportPath = "RpSoluotkhamBv.rdlc";
                    reportsoluotkham.LocalReport.DataSources.Clear();

                    // Thêm dữ liệu từ DataTable hợp nhất (PostgreSQL và SQL Server)
                    ReportDataSource rdsMerged = new ReportDataSource("DataSetSoluotkhamBv", dtMerged);
                    reportsoluotkham.LocalReport.DataSources.Add(rdsMerged);
                    ...
                    ReportParameterCollection reportParameters = new ReportParameterCollection
        {
            ...
            new ReportParameter("DenNgayPara", DenNgay.Value.ToString("dd/MM/yyyy"))
                ...
                {
                    //SqlCommand cmd = new SqlCommand("SoLuotKham3Chinhanh_2023", con);
                    //cmd.CommandType = CommandType.StoredProcedure;
                    //cmd.Parameters.AddWithValue("@TuNgay", TuNgay.Value.ToString("yyyy/MM/dd"));
                    //cmd.Parameters.AddWithValue("@DenNgay", DenNgay.Value.ToString("yyyy/MM/dd"));
                    ...
                    //reportsoluotkham.ProcessingMode = ProcessingMode.Local;
                    //reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpSoluotkham3Chinhanh.rdlc";
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    //    ReportDataSource rds = new ReportDataSource();
                    //    rds.Name = "DataSetSoluotkham3Chinhanh";
                    //    rds.Value = ds.Tables[0];
                    //    reportsoluotkham.LocalReport.DataSources.Clear();
                    //    reportsoluotkham.LocalReport.DataSources.Add(rds);
                    //    ReportParameterCollection reportParameters = new ReportParameterCollection();
                    ...
                    try
                    {
                        ...
                        {
                            // URL của Node.js API
                            string url = $"http://synthesisreport.tmhsg.com/get_marketing_solankhammotkhach_2024?startDate={startDateTime:yyyy-MM-ddTHH:mm:ss}&endDate={endDateTime:yyyy-MM-ddTHH:mm:ss}";
                                ...
                                List<string> columnsToConvert = new List<string>
            {
                "solandenkham"
                    ...
                    reportsoluotkham.ProcessingMode = ProcessingMode.Local;
                    reportsoluotkham.LocalReport.ReportPath = @"\\server-one\SynthesisReports$\RpSoluotkham3Chinhanh.rdlc";
                   // reportsoluotkham.LocalReport.ReportPath = "RpSoluotkham3Chinhanh.rdlc";
                    reportsoluotkham.LocalReport.DataSources.Clear();

                    // Thêm dữ liệu từ DataTable hợp nhất (PostgreSQL và SQL Server)
                    ReportDataSource rdsMerged = new ReportDataSource("DataSetSoluotkham3Chinhanh", dtMerged);
                    reportsoluotkham.LocalReport.DataSources.Add(rdsMerged);
